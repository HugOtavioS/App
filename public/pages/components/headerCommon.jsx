...
function HeaderCommon() {
    return (
        <header className="fixed flex justify-center items-center gap-1 top-3 left-[50%] -translate-x-[50%] bg-[#D4C9BE]/75 backdrop-blur backdrop-saturate-10 z-100 rounded-3xl w-fit px-10 p-6">
            <nav>
